...
vlog -work work myclock_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax myclock_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.myclock_tb work.glbl
