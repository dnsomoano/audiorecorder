...
xst -ifn xst.scr
move myclock_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\myclock_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc myclock_exdes.ucf myclock_exdes

echo 'Running map'
map -timing -pr b myclock_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm myclock_exdes -w routed.ncd routed.v
cd ..
